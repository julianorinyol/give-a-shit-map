class StatesImporter
  ...
  def import
    ...
    field_names = ['name', 'health_insurance', 'teen_birth', 'doctor', 'poor_health', 'obesity','state_code', 'rape', 'population', 'house', 'senate', 'total_seats', 'women_in_poverty', 'wage_gap', 'judges', 'general_poverty_rate', 'high_school_grad', 'bachelors', 'advanced_degree']
